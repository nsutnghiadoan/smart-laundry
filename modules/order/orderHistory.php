...
<body>
    <div class="container-fluid mb-5 mt-3">
        <div class="row ">
            <div class="col-lg-3">
                ...
                <button class="btn btn-primary"><a href="../../user/index.php" class="return-homepage"><i
                            class="fa-solid fa-arrow-left 2x"></i> Quay lại trang
                        chủ</a> </button>
            </div>
    ...
    <div class="container">
        <div class="row">
            <h2 class="text-center mb-5">Lịch sử giặt</h2>
        </div>
    </div>
    <div class="container">
        <table class="table">
